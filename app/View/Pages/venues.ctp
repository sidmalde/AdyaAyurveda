<div class="well">
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCpKd73IP29ruzuUucEziuLTgwnwecQfO0&sensor=false"></script>
	<h1>
		<?=$title_for_layout;?>
	</h1>
	<br />
	...
	<div class="top-spacer">
		<div class="col-sm-6">
			...
			<p>
				<address>
					Natural Health Options,<br>
					4 Buckingham Parade,<br>
					The Broadway,<br>
					Stanmore,<br>
					HA7 4EB
				</address>
				<a href="#" class="viewMap" data-latlng="51.618047, -0.311307">View on Map</a>
				<ul>
		...
		<div class="col-sm-6">
			...
			<p>
				...
				<a href="#" class="viewMap" data-latlng="51.5082475392289, -0.366192013025">View on Map</a>
				<ul>
					<li>Number 192 A is located at the back of no 192 (the main property), entrance is on the alleyway running on the right side of the main property.</li>
