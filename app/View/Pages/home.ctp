...
<div class="col-md-12">
	<div class="panel panel-success">
		...
		<div class="panel-body">
			Vaidya (Physician) Sarita Nahar holds the successful Adya
			Ayurveda pulse reading clinics in Stanmore and Southall, 
			Northwest London.
			
			Sarita has been practicing the ancient science of pulse 
			diagnosis and ayurvedic treatment since the year 2000, 
			learning it with world-renowned pulse masters Dr’s Pankaj 
			and Smita Naram. Sarita holds a BA in Ayurvedic Studies, 
			the first degree of its kind issued by a UK university.
			
			Adya Ayurveda works on correcting the root cause of disease,
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<h3 class="panel-title"><?=__('The Pulse Reading Consultation');?></h3>
		</div>
		<div class="panel-body">
			In the consultation, Vaidya Sarita reads the pulse of the patient. 
			...
			explain the treatment in detail, in dialogue with the patient.
			
			First time consultations last for up to one hour; follow up 
			consultations for up to 40 minutes.
			
			<strong>Consultation Fees are charged per person</strong>
			<ul>
				<li>First time consultation: £50</li>
				<li>Follow up consultation: £30</li>
				<li>For children under 10 years: £25 (charged for first time as well as follow up consultation)</li>
				<li>Telephone follow up consultation: £15</li>
			</ul>
